...
// import { ChangeDateBegin, ChangeDateEnd, mergeNoDup } from 'fe_ketoan/src/app/shared/shared.utils';
...
//   displayedColumns: string[] = ['SHD','Thang', 'ten', 'dvtinh', 'dgia', 'sluong', 'thtien'];
...
//     const Flat = this.ListMuavaochitiet.items.flatMap((v:any) => {
//       const dulieu = v.Dulieu.hdhhdvu as any[];
//       return dulieu
//     });
//     console.log(Flat);
    
//     this.ListMuavaochitiet.items.map((v:any)=>
//     {
//       const result = {SHD:v.SHD,Thang:v.Thang,Dulieu:v.Dulieu.hdhhdvu}
//       const newData = result.Dulieu.map((item:any) => ({
//         ...result,
//         ...item,
//       }));
//       this.Listfilter = [...this.Listfilter,...newData]
...
//     // {
//     //   v.Dulieu.forEach((v1:any)=>{v1.SHD=v.SHD,v1.Thang=v.Thang})
//     //   this.ListSanpham = [...this.ListSanpham,...v.Dulieu]
//     // })
//     // this.ListSanpham = this.ListSanpham.map((v:any)=>(
//     //   {
//     //     dgia:v.dgia,
//     //     dvtinh:v.dvtinh,
//     //     sluong:v.sluong,
...
//       this.ListSanpham = this.Listfilter.flatMap((filterEntry) => {
//         const dulieu = filterEntry.Dulieu as any[];
//         return dulieu.map((v) => ({
//          dgia:v.dgia,
//          dvtinh:v.dvtinh,
//          sluong:v.sluong,
